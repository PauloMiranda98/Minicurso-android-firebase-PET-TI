    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(txt_email.getText().length() >0 && txt_senha.getText().length() > 0) {
                    ...
                    Toast.makeText(LoginActivity.this, "O campo de email e senha não podem ficar vazio!", Toast.LENGTH_LONG).show();
                }
            }
        });
